...
class _CabPDF(FPDF):
    ...
    def header(self) -> None:
        ...
        self.cell(
            0, 6, f"SHA-256: {self._content_hash[:16]}...",
    ...
    def footer(self) -> None:
        ...
        self.cell(
            0, 4, f"Content SHA-256: {self._content_hash}",
...
def generate_cab_pdf(
    ...
    login_line = _sanitize(
        f"Generated: {meta.get('generated_at', '?')}    "
        f"Login: {meta.get('login', '?')}"
    )
    ...
    pdf.set_text_color(0, 0, 0)
    pdf.cell(
        0, 8, f"  Report integrity SHA-256: {content_hash}",
